...
- [ ] **Mappa migliorata** — nomi territori sempre visibili con font piccolo, colori continente più distinti, effetti particellari su conquista
- [ ] **Mobile responsive** — touch events, layout adattivo per tablet/telefono

## Infrastruttura
- [ ] **Deploy su cloud** — mettilo online (Render/Railway/Fly.io gratis) per farlo provare agli amici
- [ ] **PWA** — installabile come app, giocabile offline vs AI
